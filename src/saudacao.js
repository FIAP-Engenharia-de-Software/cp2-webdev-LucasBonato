...
// A função tem erros e comportamentos inesperados. Encontre e corrija os problemas usando 
// **short-circuit evaluation** (avaliação de curto-circuito com `&&` ou `||`) e **nullish coalescing (`??`)**.

function saudacao(nome, isLogged) {
  if (nome == null || nome == undefined) {
    nome = "Visitante"
  }
  return isLogged ? "Olá, " + nome + "!" : isLogged;
}
